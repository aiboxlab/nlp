...
class ConnectivesExtractorV2(FeatureExtractor):
    def __init__(self, nlp: spacy.Language | None = None):
        self._connectives = {
            'additive_neg_ratio': ['entretanto', 'mas', 'porem',
                                   'antes', 'todavia'],
            'additive_pos_ratio': ['e', 'como', 'bem como', 'alem disso'],
            'cause_neg_ratio': ['mesmo', 'embora', 'contudo', 'no entanto',
                                'apesar de', 'apesar disso', 'apesar disto',
                                'a menos que'],
            'cause_pos_ratio': ['habilita', 'para', 'se',
                                'somente se', 'assim'],
            'log_neg_ratio': ['pelo contrario', 'ainda',
                              'cada vez que', 'embora'],
            'log_pos_ratio': ['similarmente', 'por outro lado', 'de novo',
                              'somente se', 'assim', 'para este fim',
                              'desde que'],
            'and_ratio': ['e'],
            'if_ratio': ['se'],
            'logic_operators_ratio': ['e', 'ou', 'nao',
                                      'nenhum', 'nenhuma', 'se'],
